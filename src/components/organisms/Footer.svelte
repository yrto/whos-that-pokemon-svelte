<script>
	import LocaleSelector from '../molecules/LocaleSelector.svelte';
	import SvelteLogo from '../atoms/SvelteLogo.svelte';
</script>
...
<footer>
	...
	<div class="code">
		...
		<span class="github">
			Project on
			<a href="https://github.com/yrto/whos-that-pokemon-svelte">
...
<style lang="postcss">
	...
	.code {
		@apply grid grid-cols-2 font-medium text-sm divide-x divide-gray-300;
	}
	span {
		@apply flex items-center px-3 gap-1;
	}
	.credits {
